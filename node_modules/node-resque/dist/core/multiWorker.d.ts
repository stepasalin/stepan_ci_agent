...
export declare interface MultiWorker {
    ...
    on(event: "failure", cb: (workerId: number, queue: string, job: Job<any> | JobEmit, failure: Error, duration: number) => void): this;
    on(event: "error", cb: (error: Error, workerId: number, queue: string, job: Job<any> | JobEmit) => void): this;
